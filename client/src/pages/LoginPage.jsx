...
const LoginPage = () => {
  ...
  const onSubmitHandler = (e) => {
    e.preventDefault()
    console.log('Form submitted:', { password, bio,isDataSubmitted, currState })
  ...
  return (
    <div className='flex items-center bg-center bg-cover min-h-screen justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <form onSubmit={onSubmitHandler} action="" className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {currState === 'Sign Up' && !isDataSubmitted && (
          ...
          type="text" placeholder='Full Name' required className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500'/>
        )}
        ...
        { currState === 'Sign Up' && isDataSubmitted && (
          ...
          rows={4} placeholder='Provide a short Bio...' className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500'></textarea>
        )}
